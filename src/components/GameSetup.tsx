      ...
      >
        ...
        >
          <div className="relative">
            ...
            <div
              className="absolute inset-0 bg-secondary/10 blur-2xl rounded-full"
              style={{
            ...
            <div className="relative neon-border bg-gradient-to-br from-card to-muted p-3 sm:p-4 md:p-5 rounded-xl rainbow-glow">
              <Eye
                className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 text-primary floating"
                strokeWidth={1.5}
              />
              ...
              <div
                className="absolute bottom-1.5 left-1.5 w-1.5 h-1.5 bg-secondary rounded-full animate-pulse"
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            <div
              className="h-0.5 w-8 sm:w-12 bg-gradient-to-r from-transparent via-primary to-primary"
              style={{
            ...
            <div
              className="h-0.5 w-8 sm:w-12 bg-gradient-to-l from-transparent via-primary to-primary"
              style={{
                boxShadow: "0 0 10px rgba(14, 165, 233, 0.8)",
              }}
            />
          ...
          {[
            {
              icon: Users,
              title: "3-12 PEMAIN",
              desc: "Seru dimainkan bersama",
              color: "text-primary",
              bgColor: "bg-primary/10",
            },
            {
              icon: Zap,
              title: "DEDUKSI SOSIAL",
              desc: "Bohong, tipu, bertahan",
            ...
            >
              <div
                className={`${feature.bgColor} w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center mx-auto mb-2`}
              >
                <feature.icon
              ...
              <h3
                className="text-foreground mb-1 text-[10px] sm:text-xs"
                style={{
                  fontFamily: "Orbitron",
                  letterSpacing: "0.1em",
                }}
