      ...
      >
        ...
        >
          <div className="relative">
            ...
            <div className="relative neon-border bg-gradient-to-br from-card to-muted p-10 rounded-3xl rainbow-glow">
              <Eye className="w-24 h-24 text-primary floating" strokeWidth={1.5} />
              
              {/* Corner decorations */}
              <div className="absolute top-2 right-2 w-3 h-3 bg-primary rounded-full animate-pulse" />
              <div className="absolute bottom-2 left-2 w-3 h-3 bg-secondary rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
            </div>
            ...
            >
              <Shield className="absolute -top-2 left-1/2 -ml-3 w-6 h-6 text-blue-400" />
            </motion.div>
            <motion.div
              animate={{ rotate: -360 }}
              ...
              className="absolute inset-0 pointer-events-none"
            >
              <Target className="absolute -bottom-2 left-1/2 -ml-3 w-6 h-6 text-orange-400" />
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          <h1 
            className="text-5xl sm:text-7xl neon-text mb-4 text-center" 
            style={{ 
              fontFamily: 'Orbitron', 
              fontWeight: 900, 
              fontStyle: 'normal',
              letterSpacing: '0.1em' // Reduced from 0.2em
            }}
          >
            UNDERCOVER
          </h1>
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            <div className="h-1 w-20 bg-gradient-to-r from-transparent via-primary to-primary" style={{ boxShadow: '0 0 10px rgba(14, 165, 233, 0.8)' }} />
            <Sparkles className="w-6 h-6 text-primary animate-pulse" />
            <div className="h-1 w-20 bg-gradient-to-l from-transparent via-primary to-primary" style={{ boxShadow: '0 0 10px rgba(14, 165, 233, 0.8)' }} />
          </div>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-xl sm:text-2xl text-muted-foreground mb-12 tracking-[0.15em]"
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="neon-border bg-card/30 backdrop-blur-sm p-6 rounded-xl tech-corners hover:bg-card/50 transition-all cursor-pointer"
            >
              ...
              <h3 className="text-foreground mb-2 text-sm" style={{ fontFamily: 'Orbitron', letterSpacing: '0.1em' }}>
                {feature.title}
              </h3>
        ...
        >
          <Button
            onClick={handleStart}
            className="bg-primary hover:bg-primary/90 text-primary-foreground px-12 py-7 text-xl rounded-xl pulse-glow group"
        ...
        >
          ...
          <p className="text-muted-foreground text-sm" style={{ fontFamily: 'Rajdhani', letterSpacing: '0.2em' }}>
            BY IKY
          </p>
